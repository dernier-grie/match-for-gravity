--[[
updated version of
https://github.com/borntofrappe/game-development/blob/main/Utils/Timer/Tween/Timer.lua

renames first argument for delays, intervals, tweens
interpolates tween instead of adding a delta; enables easing
]]
Timer = {}
